...
parser.add_argument('--model', type=str, default='model/rationale_roberta_large_scifact/')
parser.add_argument('--abstract-retrieval', default='prediction/abstract_retrieval.jsonl')
parser.add_argument('--threshold', type=float, default=0.5, required=False)
parser.add_argument('--only-rationale', action='store_true')
parser.add_argument('--output-flex', type=str, default='prediction/rationale_selection.jsonl')
