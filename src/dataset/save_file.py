...
corpus = {doc['doc_id']: doc for doc in jsonlines.open('/home/g19tka09/Documents/SCIVER/data/corpus.jsonl')}


def abstract_retrieval(dataset, output, state='train', include_nei=False):
    '''
    oracle-abstract
...
def tfidf_abstract(dataset, output, min_gram, max_gram, args):
    '''
