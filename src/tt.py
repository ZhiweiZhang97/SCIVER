...
parser.add_argument('--dataset', type=str, default='../data/claims_dev_retrieval.jsonl')
parser.add_argument('--model', type=str, default='model/label_roberta_large_fever_scifact/')
parser.add_argument('--rationale-selection', type=str, default='prediction/rationale_selection.jsonl')
parser.add_argument('--mode', type=str, default='claim_and_rationale', choices=['claim_and_rationale', 'only_claim', 'only_rationale'])
parser.add_argument('--output', type=str, default='prediction/label_predictions.jsonl')
